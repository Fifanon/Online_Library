...
import (
	...
	"online_library/modules/github.com/gorilla/sessions"
	_"online_library/modules/github.com/gorilla/securecookie"
	_ "online_library/modules/go-sql-driver/mysql"
	vars "online_library/varsAndFuncs"
	stct "online_library/structs"
	user "online_library/user"
	searchbk "online_library/searchBook"
	bk "online_library/operationsOnBook"
	mber "online_library/operationsOnMemb"
	brwbk "online_library/borrowBook"
	disp "online_library/displayBooks"
